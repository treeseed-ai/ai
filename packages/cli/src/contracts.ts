...
export const packageNames={platform:'treeseed-ai-manager',qualify:'treeseed-ai-manager',update:'treeseed-ai-manager',mode:'treeseed-ai-manager',config:'treeseed-ai-manager',recovery:'treeseed-ai-manager','local-build':'treeseed-ai-manager',host:'treeseed-ai-host-runtime',inference:'treeseed-ai-inference',training:'treeseed-ai-training',lab:'treeseed-ai-lab'}as const;
export const executables={platform:'/usr/lib/treeseed-ai/manager/dist/cli.js',qualify:'/usr/lib/treeseed-ai/manager/dist/cli.js',update:'/usr/lib/treeseed-ai/manager/dist/cli.js',mode:'/usr/lib/treeseed-ai/manager/dist/cli.js',config:'/usr/lib/treeseed-ai/manager/dist/cli.js',recovery:'/usr/lib/treeseed-ai/manager/dist/cli.js','local-build':'/usr/lib/treeseed-ai/manager/dist/cli.js',host:'/usr/lib/treeseed-ai/host-runtime/dist/cli.js',inference:'/usr/lib/treeseed-ai/cli/dist/product-cli.js',training:'/usr/lib/treeseed-ai/cli/dist/product-cli.js',lab:'/usr/lib/treeseed-ai/lab/dist/cli.js'}as const;
