...
const smokeCommands: Record<string, string[]> = {
	...
	"axolotl-worker": ["python3", "-c", "import axolotl,accelerate,torchvision; from transformers.models.qwen3_5 import Qwen3_5Config; assert Qwen3_5Config.model_type == 'qwen3_5'"],
