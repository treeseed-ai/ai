...
Release 0.6.0 supports Ubuntu 26.04 (Resolute) amd64. Download one generic or generated configuration package and install it locally:

```bash
sudo apt install ./treeseed-ai_0.6.0-1_amd64.deb
